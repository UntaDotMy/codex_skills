...
2. `MEMORY.md`
3. `memory_summary.md`
4. `raw_memories.md` only when the higher-priority sources are too thin

## Status Labels

- **Healthy**: rollouts exist, no failed tasks, and no open mistakes
- **Mixed**: work exists but there are partial tasks, open mistakes, or unclear mistakes
- **Needs Attention**: failed tasks exist or open mistakes outweigh resolved mistakes
