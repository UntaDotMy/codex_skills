...
class SkillPackContractTests(unittest.TestCase):
    ...
    def test_agent_prompts_keep_cache_handoff_and_autonomy_guidance(self) -> None:
        ...
        self.assertIn("release checks", reviewer_agent_text)
        self.assertIn("gap-finding", reviewer_agent_text)
        self.assertIn("rollback or observability risk", reviewer_agent_text)
        self.assertIn("partial implementation", reviewer_agent_text)
        self.assertIn("Black", reviewer_agent_text)
        self.assertIn("Ruff", reviewer_agent_text)
        self.assertIn("MyPy", reviewer_agent_text)
        self.assertIn("circular import", reviewer_agent_text)
        self.assertIn("import-safety", reviewer_agent_text)
        self.assertIn("Prettier", reviewer_agent_text)
        self.assertIn("passed, failed, skipped, or blocked", reviewer_agent_text)
    ...
    def test_core_guidance_requires_lifecycle_scenario_thinking(self) -> None:
        ...
        validator_script_text = read_text(REPOSITORY_ROOT / "sync-skills.sh")
        ...
        self.assertIn("Language-Specific Quality Gates (CRITICAL)", reviewer_skill_text)
        self.assertIn("black --check", reviewer_skill_text)
        self.assertIn("ruff check", reviewer_skill_text)
        self.assertIn("mypy", reviewer_skill_text)
        self.assertIn("Import Linter", reviewer_skill_text)
