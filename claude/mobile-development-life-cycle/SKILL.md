...
description: Mobile app development for Android and iOS. Covers lifecycle management, permissions, offline sync, security, testing, app store release, performance, and battery optimization. TRIGGER when building mobile apps, handling permissions, implementing offline features, or preparing app store submissions.
