...
Use this index to select the minimum relevant UX reference set.

## Capability Matrix

| Need | Primary Reference |
|---|---|
| Research planning and discovery | `10-ux-research-and-discovery.md` |
| IA, journeys, interaction design, CTA clarity | `20-information-architecture-and-interaction.md` |
...
1. Clarify target users, outcomes, and constraints.
